...
export const generateArticleFromTicket = async (fullMessage, messageType) => {
  const systemMessages = [
    ...
    {
      role: "system",
      content: "synthesize and be as clear as possible in describing the solution.",
    },
    {
      role: "system",
      content: "Don't mention internal or Jira ticket.",
    },
    {
      role: "system",
      content: "Do not mention that the solution comes from the R&D team and remain generic.",
    },
  ];
